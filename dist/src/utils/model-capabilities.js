...
export function saveCache(baseDir, cache) {
    const fp = cachePath(baseDir);
...
export function isMultimodalCapable(caps) {
 ...
 */
export function resolveCurrentModel(config) {
 ...
 */
export function recordAndClassify(baseDir, model) {
    if (!model) {
