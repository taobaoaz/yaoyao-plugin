...
export function formatBackendsReport(files, dreamEvents, yaoInfo) {
    const lines = ["# 🔍 记忆后端详情", ""];
    ...
    for (const line of yaoInfo)
        lines.push(line);
    return lines.join("\n");
}
export function formatCrossSearchResults(query, ocResults, dreamMatches) {
