 ...
 */
import { getTopPatterns, getToolStats } from "../../core/skills/tracker.js";
import { analyzeSkills, formatSuggestions } from "../../core/skills/analyzer.js";
export function createSkillAnalyticsTool() {
    return {
        ...
        handler: async (args) => {
            ...
            if (action === "stats") {
                ...
                if (!toolId)
                    return { error: "toolId required for stats" };
