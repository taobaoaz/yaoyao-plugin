...
function stripEnglishSuffix(word) {
    if (word.length <= 3)
        return { stem: word, preserveOriginal: false };
    const original = word;
    let stem = word;
 ...
 */
export function getBM25SigmoidParams(query) {
 ...
 */
export function normalizeBM25Score(rawScore, params) {
