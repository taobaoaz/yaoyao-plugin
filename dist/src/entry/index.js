...
import { getAdaptedApiExtended } from "./xiaoyi-adapter.js";
    ...
    register(api) {
        try {
            ...
            if (telemetryConfig.enabled) {
                ...
                // 注册清理函数（当插件卸载时清理定时器）
                const hasUnload = api && typeof api.onUnload === 'function';
