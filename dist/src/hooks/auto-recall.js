// Auto-synced from src\hooks\auto-recall.ts by sync-dist.mjs — review if issues arise
/**
...
function applyDiversitySampling(results) {
 if (results.length <= 1) return results;
...
export function registerRecallHook(
 ...
 api.logger.debug?.("[yaoyao-memory:recall] No keywords, using most recent memory");
