// Auto-synced from src\tools\memory-export.ts by sync-dist.mjs — review if issues arise
/**
...
export function createExportTool(store, dbBridge) {
 ...
 if (dateFrom) { conditions.push("date >= ?"); bindParams.push(dateFrom); }
 ...
 String(r.user_text || "").toLowerCase().includes(kw) ||
