...
export function createExportTool(store) {
    return {
        name: "memory_export",
        ...
        execute: withErrorHandling(async (_id, params) => {
            ...
            try {
                ...
                const stmt = db.prepare(`SELECT date, user_text, asst_text, created_at FROM memory_meta ${whereClause} ORDER BY date DESC, id DESC LIMIT ?`);
