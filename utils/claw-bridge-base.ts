...
export class ClawBridgeBase {
  ...
  protected healthCheckMs: number;

  protected sock: net.Socket | null = null;
  protected _buf = Buffer.alloc(0);
  protected _nextId = 1;
  protected _connected = false;
  protected _connectPromise: Promise<void> | null = null;
  protected _healthTimer: ReturnType<typeof setTimeout> | null = null;

  protected _pending = new Map<string, PendingReq>();
  protected _queue: PendingReq[] = [];
