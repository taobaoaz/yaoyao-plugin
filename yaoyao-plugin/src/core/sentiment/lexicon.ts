/**
 * core/sentiment/lexicon.ts — Chinese/English emotion lexicons and emoji markers.
 *
 * Ekman 6 basic emotions: joy, sadness, anger, fear, surprise, disgust.
 */
import type { EmotionLabel } from "./types.ts";
