...
describe("parseSupportInfo", () => {
  ...
  it("parses V2 format", () => {
    const raw = {
      ...
      slices: [
        { context: "work", confirmations: 5, contradictions: 1, strength: 0.83, last_observed_at: 1700000000000 },
      ],
    };
...
describe("updateSupportStats", () => {
  ...
  it("updates existing slice", () => {
    const base = {
      ...
      slices: [{ context: "work", confirmations: 1, contradictions: 0, strength: 1, last_observed_at: 1700000000000 }],
    };
