 ...
 */
import { extractAtomicFacts } from "../../core/atomic/extract.js";
import { saveFact, findFactsByEntity, getAllFacts } from "../../core/atomic/store.js";
import { queryFacts, summarizeFacts } from "../../core/atomic/query.js";
export function createAtomicFactTool() {
    return {
        ...
        handler: async (args) => {
            ...
            if (action === "extract") {
                ...
                const result = extractAtomicFacts(text, mode);
