...
import { discoverMemoryFiles } from "../../utils/discover-memory-files.js";
/** Import existing memories from workspace files at startup. */
export function stepImportExistingMemories(logger, workspaceDir, _config, store, storage) {
    ...
    logger?.info?.(`[yaoyao-memory] Memory import complete: ${imported} entries from ${processedFiles} files, ${skipped} skipped`);
