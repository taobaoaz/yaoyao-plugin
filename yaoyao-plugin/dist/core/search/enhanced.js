...
export function highlightKeywords(text, keywords) {
    if (typeof text !== "string")
        throw new TypeError("highlightKeywords: text must be a string");
    if (!Array.isArray(keywords))
        throw new TypeError("highlightKeywords: keywords must be an array");
    let result = text;
...
export function extractKeywords(text) {
    if (typeof text !== "string")
        throw new TypeError("extractKeywords: text must be a string");
...
export function cosineSimilarity(a, b) {
    if (!ArrayBuffer.isView(a) || !(a instanceof Float32Array))
        throw new TypeError("cosineSimilarity: a must be a Float32Array");
    if (!ArrayBuffer.isView(b) || !(b instanceof Float32Array))
        throw new TypeError("cosineSimilarity: b must be a Float32Array");
