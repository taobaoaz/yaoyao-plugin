...
export function readMmapState() {
    if (!existsSync(MMAP_PATH))
        return null;
    try {
        ...
        return {
            ...
            methods: Array.isArray(data.methods) ? data.methods.filter((m) => typeof m === "string") : undefined,
...
export function isGatewayAlive(thresholdMs = 15000) {
...
export function hasGatewayMethod(method) {
