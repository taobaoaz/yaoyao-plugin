...
const KNOWN_ENTITIES = new Set([
  ...
  "react", "vue", "angular", "svelte", "solidjs", "preact", "lit", "stencil",
  "nextjs", "nuxt", "remix", "gatsby", "astro", "qwik",
  "express", "fastify", "nest", "nestjs", "spring", "springboot", "django", "flask", "rails",
  "tailwind", "bootstrap", "materialui", "chakra", "shadcn", "antd", "semanticui",
  "pytorch", "tensorflow", "keras", "jax", "langchain", "llamaindex",
  "huggingface", "transformers", "diffusers",
  "jquery", "lodash", "rxjs", "redux", "zustand", "jotai", "recoil",
  "prisma", "typeorm", "sequelize", "knex", "drizzle",
  "graphql", "apollo", "relay",
  "socketio", "grpc", "rest", "trpc",
  "electron", "tauri", "reactnative", "flutter", "ionic", "capacitor",

  // ── Languages ──
  "typescript", "javascript", "ecmascript", "python", "rust", "go", "golang",
  "java", "kotlin", "swift", "objectivec", "csharp", "cpp", "cplusplus",
  "ruby", "php", "scala", "elixir", "haskell", "clojure", "erlang",
  "zig", "nim", "vlang", "mojo", "dart",
  "sql", "bash", "shell", "powershell", "perl", "lua",

  // ── Databases ──
  "postgresql", "postgres", "mysql", "mariadb", "sqlite", "duckdb",
  "mongodb", "couchdb", "realm", "firestore",
  "redis", "valkey", "memcached",
  "elasticsearch", "opensearch", "meilisearch", "typesense",
  "clickhouse", "druid", "pinot",
  "cassandra", "scylla", "dynamodb", "cosmosdb",
  "neo4j", "arangodb", "janusgraph",
  "influxdb", "timescaledb", "questdb",
  "kafka", "pulsar", "rabbitmq", "nats", "zeromq",

  // ── Cloud & infra ──
  "aws", "gcp", "azure", "alicloud", "tencentcloud", "huaweicloud",
  "kubernetes", "k8s", "docker", "podman", "containerd",
  "terraform", "pulumi", "ansible", "chef", "puppet",
  "nginx", "caddy", "apache", "haproxy", "envoy", "traefik",
  ...
  "clean architecture", "hexagonal", "hexagonal architecture", "onion", "onion architecture",
  "microservices", "microservice", "monolith", "monolithic",
  "eventdriven", "eventsourcing", "cqrs", "event sourcing",
  "mvc", "mvvm", "mvp", "flux",
  "soa", "serverless", "lambda", "faas",
  "ddd", "domain driven design", "tdd", "bdd",
  "restful", "rest api", "graphql",

  // ── Chinese entities ──
  "微信", "wechat", "支付宝", "alipay", "华为", "huawei",
  "阿里", "alibaba", "腾讯", "tencent", "字节", "bytedance",
  "百度", "baidu", "小米", "xiaomi", "美团", "meituan",
  "京东", "jd", "拼多多", "pinduoduo", "滴滴", "didier",
  "鸿蒙", "harmonyos", "harmony", "方舟",
  "微博", "weibo", "小红书", "xhs", "抖音", "douyin", "tiktok",

  // ── Operating systems ──
  "linux", "macos", "windows", "ubuntu", "debian", "centos", "rhel",
  "fedora", "arch", "alpine", "suse", "redhat",
  "android", "ios", "ipados", "tvos", "watchos",
  "freebsd", "openbsd", "netbsd",

  // ── AI/ML ──
  "gpt", "gpt4", "gpt4o", "claude", "llama", "mistral", "gemini",
  "openai", "anthropic", "googleai",
  "rag", "finetune", "finetuning", "rlhf", "dpo", "ppo",
  "embedding", "embeddings", "vector", "semantic search",
  "llm", "ml", "nlp", "ner", "pos",

  // ── Testing ──
  "jest", "vitest", "mocha", "chai", "cypress", "playwright",
  "pytest", "unittest", "selenium", "webdriver",
]);
 ...
 */
export function computeEntityBoost(queryEntities: string[], memoryEntities: string[]): number {
 ...
 */
export function computeEntityBoostFromTexts(query: string, memorySnippet: string): number {
  if (!query || !memorySnippet) return 0;
