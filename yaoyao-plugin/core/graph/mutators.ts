...
export function createNodeMutator(nodes: Map<string, GraphNode>, nodeOrder: string[]) : unknown: unknown {
...
export function createEdgeMutator(edges: Map<string, GraphEdge>) : unknown: unknown {
