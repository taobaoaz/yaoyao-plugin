...
export function createNodeMutator(nodes: Map<string, GraphNode>, nodeOrder: string[]): NodeMutator {
...
export function createEdgeMutator(edges: Map<string, GraphEdge>): EdgeMutator {
