 ...
 * 从 Brain (memory-lancedb-pro) 学习：过滤 denials、meta-questions、boilerplate、short boilerplate
 * 纯正则实现，零外部依赖
 */

// Agent-side denial patterns (AI says it doesn't remember)
...
// Session boilerplate - anchored to start AND end to prevent false positives
...
// Short boilerplate: only noise when text is short enough to be pure filler
