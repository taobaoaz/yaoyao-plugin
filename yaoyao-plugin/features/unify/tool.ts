...
import { formatStatusReport, formatBackendsReport, formatCrossSearchResults } from './formatter.ts';
      ...
      if (action === 'backends') {
        ...
        return {
          content: [
            {
              type: 'text',
              text: formatBackendsReport(
                files,
                dreams.events as Array<Record<string, unknown>>,
                yaoInfo,
              ),
            },
          ],
      ...
      if (action === 'search_all') {
        ...
        return {
          content: [
            {
              type: 'text',
              text: formatCrossSearchResults(
                query,
                ocResults,
                dreamMatches as Array<Record<string, unknown>>,
              ),
            },
          ],
        };
