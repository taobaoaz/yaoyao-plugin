...
export function readDreams(memoryDir: string): { events: unknown[]; shortTermRecall: unknown | null } {
  const result = { events: [] as unknown[], shortTermRecall: null as unknown | null };
