...
import { tokenize } from '../core/search/bm25-tokenize.ts';
import { buildBM25Index, scoreBM25, bm25Search } from '../core/search/bm25.ts';
...
describe('bm25', () => {
  ...
  it('bm25Search returns sorted results', () => {
    const docs = ['The quick brown fox', 'The lazy dog', 'The quick brown fox jumps'];
  ...
  it('prefers exact match over partial', () => {
    const docs = ['cat dog bird', 'cat dog', 'bird'];
