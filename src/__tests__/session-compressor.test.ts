...
import { scoreText, compressTexts, estimateConversationValue } from "../utils/session-compressor.ts";
...
describe("scoreText", () => {
  ...
  it("scores substantive text as 0.7", () => {
    const s = scoreText("This is a long substantive message with lots of content that exceeds the minimum threshold.", 0);
