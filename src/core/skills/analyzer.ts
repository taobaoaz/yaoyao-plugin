...
import type { ToolPattern, SkillSuggestion } from "./types.ts";
import { getPatterns, getToolStats } from "./tracker.ts";

function generateShortcutSuggestion(patterns: ToolPattern[]): SkillSuggestion | null {
...
function generateOptimizationSuggestion(patterns: ToolPattern[]): SkillSuggestion | null {
  // Find slow patterns
...
function generateAutomationSuggestion(patterns: ToolPattern[]): SkillSuggestion | null {
...
function generateNewFeatureSuggestion(): SkillSuggestion | null {
